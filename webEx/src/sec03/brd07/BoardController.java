	...
	private void doHandle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (action == null) {
				...
				pw.print("<script>" + "  alert('占쏙옙占쏙옙占쏙옙 占쌩곤옙占쌩쏙옙占싹댐옙.');" + " location.href='" + request.getContextPath()
				...
				PrintWriter pw = response.getWriter();
				pw.print("<script>" + "  alert('占쏙옙占쏙옙 占쏙옙占쏙옙占쌩쏙옙占싹댐옙.');" + " location.href='" + request.getContextPath()
				...
				PrintWriter pw = response.getWriter();
				pw.print("<script>" + "  alert('占쏙옙占쏙옙占� 占쌩곤옙占쌩쏙옙占싹댐옙.');" + " location.href='" + request.getContextPath()
						+ "/board/viewArticle.do?articleNO="+articleNO+"';" + "</script>");
				return;
			}
		...
		try {
			...
			for (int i = 0; i < items.size(); i++) {
				...
				if (fileItem.isFormField()) {
					...
					System.out.println("占쏙옙占쏙옙크占쏙옙:" + fileItem.getSize() + "bytes");
